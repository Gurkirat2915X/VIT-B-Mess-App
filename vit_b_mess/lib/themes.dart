...
final ThemeData messLightTheme = ThemeData(
  ...
  appBarTheme: AppBarTheme(
    backgroundColor: Color(0xFF388E3C), // A darker green for good contrast with logo and primary color
  ...
  textTheme: TextTheme(
    headlineSmall: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF212121)),
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    selectedItemColor: Color(0xFF4CAF50), // Same as primary color
...
final ThemeData messDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme.fromSeed(
    ...
    surface: Color(0xFF1E1E1E),     // Cards, bottom sheets
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    selectedItemColor: Color(0xFF81C784), // Same as primary color
    unselectedItemColor: Colors.white70,
    backgroundColor: Color(0xFF1E1E1E), // Same as card color
  ),
);
