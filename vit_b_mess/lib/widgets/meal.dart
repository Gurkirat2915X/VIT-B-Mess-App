...
class _MealWidgetState extends ConsumerState<MealWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final fixedHeight =
        screenHeight * 0.35; // 35% of screen height (reduced from 45%)
              ...
              children: [
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.currentMeal.nonVeg.isNotEmpty &&
                                !settings.onlyVeg)
                              _buildModernSection(
                                context,
                                "Non-Vegetarian",
                            ...
                            if (widget.currentMeal.veg.isEmpty &&
                                (widget.currentMeal.nonVeg.isEmpty ||
                                    settings.onlyVeg))
                ...
                if (_showTopIndicator)
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: _buildScrollIndicator(colorScheme, isTop: true),
                  ),
                ...
                if (_showBottomIndicator)
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: _buildScrollIndicator(colorScheme, isTop: false),
                  ),
              ],
            ),
          ),
